...
write.csv(rawdata, file = "rawdataFM2012.csv")
...
write.csv(normdata, file = "normdataFM2012.csv")
...
bhatt.coeff(normpprf, normpmrf) # 1
bhatt.coeff(normpprf, normparf) # 1
bhatt.coeff(normpmrf, normparf) # 1
bhatt.coeff(normpmrf, normmarf) # 0.8130525
bhatt.coeff(normparf, normmarf) # 0.8130525
...
### RF
# paup-morphy
wilcox.test(pprf, mmrf) # W = 225, p-value = 0.05042
# neither larger

# paup-ana
wilcox.test(pprf, aarf) # W = 26001, p-value = 3.879e-09
# pprf > aarf

# morphy-ana
wilcox.test(mmrf, aarf) # W = 5065.5, p-value = 0.3067
# neither larger

### Quartet
# paup-morphy
wilcox.test(ppqu, mmqu) # W = 243, p-value = 0.01647
# ppqu > mmqu

# paup-ana
wilcox.test(ppqu, aaqu) # W = 27429, p-value = 8.147e-12
# ppqu > mmqu
  
# morphy-ana
wilcox.test(mmqu, aaqu) # W = 5065.5, p-value = 0.3067
# neither larger
...
pdf("Figures/RF MDS with density distribution FM2012.pdf", 8, 5.3)
ggdraw() +
...
pdf("Figures/Quartet MDS with density distribution FM2012.pdf", 8, 5.3)
ggdraw() +
