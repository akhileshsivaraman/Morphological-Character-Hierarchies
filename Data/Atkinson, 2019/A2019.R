...
bhatt.coeff(normpmrf, normparf) # 0.6716255
bhatt.coeff(normpmrf, normmarf) # 0.8286226
bhatt.coeff(normparf, normmarf) # 0.9082112
...
bhatt.coeff(normpmqu, normpaqu) # 0.3889115
bhatt.coeff(normpmqu, normmaqu) # 0.57536
bhatt.coeff(normpaqu, normmaqu) # 0.9353555
...
### RF
# paup-morphy
t.test(pprf, mmrf) # t = -261.84, df = 10828, p-value < 2.2e-16
# mmrf > pprf

# paup-ana
t.test(pprf, aarf) # t = -257.92, df = 3749.6, p-value < 2.2e-16
# aarf > pprf

# morphy-ana
t.test(mmrf, aarf) # t = -58.382, df = 7434, p-value < 2.2e-16
# aarf > mmrf

### Quartet
# paup-morphy
t.test(ppqu, mmqu) # t = -234.72, df = 10994, p-value < 2.2e-16
# mmqu > ppqu

# paup-ana
t.test(ppqu, aaqu) # t = -139.75, df = 3669.7, p-value < 2.2e-16
# aaqu > ppqu

# morphy-ana
t.test(mmqu, aaqu) # t = -30.999, df = 5079.4, p-value < 2.2e-16
# aaqu > mmqu
