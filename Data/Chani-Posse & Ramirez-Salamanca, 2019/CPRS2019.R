##### Chani-Posse & Ramirez-Salamancq, 2019 #####
...
# paup
pauptrees <- read.nexus("Pauptrees-CPRS2019.tre")
...
# morphy
morphytrees <- read.nexus("MorphyNoRat-CPRS2019.tre")
morphy <- read.nexus("Morphycontree-CPRS2019.tre")
...
write.csv(rawdata, file = "rawdataCPRS2019.csv")
...
write.csv(normdata, file = "normdataCPRS2019.csv")
...
### RF
# paup-morphy
t.test(pprf, mmrf) # t = -29.733, df = 17468, p-value < 2.2e-16
# mmrf > pprf

### Quartet
# paup-morphy
t.test(ppqu, mmqu) # t = 41.567, df = 11822, p-value < 2.2e-16
# ppqu > mmqu
...
pdf("Figures/RF MDS with density distribution CPRS2019.pdf", 8, 5.3)
ggdraw() +
...
# Scatter plot with marginal density distribution plot
jitter <- position_jitter(width = 100, height = 150)
...
pdf("Figures/Quartet MDS with density distribution CPRS2019.pdf", 8, 5.3)
ggdraw() +
