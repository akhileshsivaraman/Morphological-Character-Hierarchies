...
bhatt.coeff(normpprf, normpmrf) # 0.5773503
bhatt.coeff(normpprf, normparf) # 1
bhatt.coeff(normpmrf, normparf) # 0.5773503
bhatt.coeff(normpmrf, normmarf) # 1
bhatt.coeff(normparf, normmarf) # 0.5773503
...
bhatt.coeff(normppqu, normpmqu) # 0.5773503
bhatt.coeff(normppqu, normpaqu) # 1
bhatt.coeff(normpmqu, normpaqu) # 0.5773503
bhatt.coeff(normpmqu, normmaqu) # 1
bhatt.coeff(normpaqu, normmaqu) # 0.5773503


#### t-test/Wilcoxon - sample too small don't use ####
...
pdf("Figures/Quartet MDS with density distribution D2016.pdf", 8, 5.3)
ggdraw() +
